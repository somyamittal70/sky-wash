...
export default function ServicesGrid() {
  ...
  return (
    <>
      <section className="bg-[#fcfdfe] py-20 sm:py-32 relative overflow-hidden" id="interactive-catalog">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {/* LEFT SIDE: Core High-Conversion Pitch System */}
            ...
            <h2 className="font-['Nunito'] text-4xl sm:text-5xl font-black text-[#0a1f47] tracking-tight leading-[1.15]">
              Hover to inspect specs. <br />
              <span className="text-slate-400">Click anywhere to deploy service.</span>
            </h2>
          </div>
                  ...
                  <div className="relative h-full w-full rounded-[2rem] transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] shadow-md group-hover:shadow-2xl">
                    ...
                    <div className="absolute inset-0 h-full w-full rounded-[2rem] bg-white border border-slate-200/80 p-8 flex flex-col justify-between [backface-visibility:hidden] [transform:rotateY(180deg)] shadow-lg">
                      ...
                      <div className="pt-5 border-t border-slate-100 flex items-center justify-between">
                        ...
                        <button className="inline-flex items-center gap-2 rounded-xl bg-[#154088] text-white px-5 py-3 font-['Nunito'] font-black text-xs uppercase tracking-wider hover:bg-[#0a1f47] transition-colors shadow-md shadow-[#154088]/20">
                          <span>Book</span>
