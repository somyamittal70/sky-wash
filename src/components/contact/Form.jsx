...
export default function ContactFormMap() {
  ...
  return (
    <section
      className="relative overflow-hidden bg-white text-[#001230] py-24 sm:py-36"
    ...
    >
      ...
      {/* High-Elegance Cosmic Atmosphere Glows */}
      <div className="absolute top-12 left-1/4 -z-10 h-[500px] w-[500px] rounded-full bg-gradient-to-tr from-[#154088]/10 via-[#154088]/5 to-transparent blur-[120px] pointer-events-none" />
      <div className="absolute bottom-12 right-1/4 -z-10 h-[500px] w-[500px] rounded-full bg-gradient-to-br from-[#154088]/10 to-transparent blur-[120px] pointer-events-none" />

      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid items-stretch gap-16 lg:grid-cols-[1fr_1.1fr] lg:gap-20">
          ...
          <div className="flex flex-col justify-between py-2">
            <div className="max-w-xl">
              ...
              <h2 className="font-['Nunito'] mt-6 text-4xl font-black tracking-tight text-[#001230] sm:text-5xl lg:text-6xl leading-[1.05]">
              ...
              <p className="font-['Open_Sans'] mt-6 text-base sm:text-lg leading-relaxed text-[#676a73] font-medium">
            ...
            {submitted ? (
              <div className="mt-10 rounded-3xl bg-[#154088]/5 border border-emerald-500/30 p-8 shadow-xl backdrop-blur-md relative overflow-hidden">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-['Open_Sans'] text-sm text-[#676a73] mt-1.5 leading-relaxed">
                      Your transmission has cleared parameters successfully. A
                      priority agent will trace back via{" "}
              ...
              >
                ...
                <button
                  type="submit"
                  className="group w-full sm:w-auto inline-flex items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-[#154088] to-[#0e2c5f] hover:from-[#1c4c9c] hover:to-[#123a7a] px-8 py-4 font-['Nunito'] font-black text-sm text-white shadow-xl shadow-[#154088]/20 transition-all duration-300 hover:-translate-y-0.5 active:scale-95"
                >
                  Dispatch Transmission
                  <Send
                    size={14}
                    className="transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 stroke-[2.5]"
                  />
                </button>
              </form>
            )}
          ...
          <div className="flex flex-col gap-6 justify-between lg:h-full">
            ...
            <div className="relative rounded-[2.5rem] p-3 bg-[#9a9ca1]/5 border border-[#9a9ca1]/30 shadow-xl flex-1 flex flex-col min-h-[380px] backdrop-blur-md">
              <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#9a9ca1]/40 to-transparent" />
              ...
              <div className="w-full flex-1 rounded-[1.75rem] overflow-hidden relative border border-[#9a9ca1]/30 shadow-inner">
                <iframe
                ...
                ({ id, icon: Icon, label, value, href, status }) => {
                  ...
                  const containerStructure = (
                    <div
                      ...
                      className={`flex items-center justify-between gap-4 rounded-2xl border p-4 transition-all duration-300 cursor-pointer text-left h-full group ${
                        isActive
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        <div
                          className={`flex shrink-0 items-center justify-center w-11 h-11 rounded-xl transition-colors ${
                            isActive
                              ? "bg-gradient-to-r from-[#154088] to-[#0e2c5f] text-white"
                              : "bg-white border border-[#9a9ca1]/30 text-[#676a73] group-hover:text-[#154088]"
                          }`}
                        >
