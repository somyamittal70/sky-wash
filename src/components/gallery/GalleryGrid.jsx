  ...
  return (
    <section className="relative overflow-hidden bg-[#ffffff] text-[#334155] py-18 sm:py-22 border-b border-slate-200/60" id="gallery-grid">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-[-10%] w-[600px] h-[600px] bg-[#154088]/5 rounded-full blur-[140px]" />
        <div className="absolute bottom-1/4 right-[-10%] w-[600px] h-[600px] bg-[#5b86c9]/5 rounded-full blur-[140px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 pb-12 border-b border-slate-100">
          ...
          <div className="flex flex-wrap gap-1.5 bg-slate-100/80 border border-slate-200/60 p-1.5 rounded-2xl backdrop-blur-md self-start lg:self-auto">
            {filters.map((filter) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-xl px-5 py-2.5 font-['Nunito'] text-sm font-black tracking-tight transition-all duration-300 relative ${
                    isSelected
                      ? 'bg-gradient-to-r from-[#154088] to-[#0a1f47] text-white shadow-md shadow-[#154088]/10'
                      : 'text-[#475569] hover:text-[#0a1f47] hover:bg-slate-200/50'
                  }`}
                >
                  {filter}
                </button>
        ...
        <div className="mt-12 columns-1 sm:columns-2 lg:columns-3 gap-6 [column-fill:_balance]">
          {filtered.map(({ id, img, title, category, tall }) => (
            <div
              key={id}
              className={`group relative mb-6 break-inside-avoid rounded-3xl overflow-hidden border border-slate-200/80 bg-slate-50 shadow-[0_15px_30px_-15px_rgba(21,64,136,0.04)] transition-all duration-300 hover:border-[#154088]/30 hover:shadow-2xl hover:shadow-[#154088]/10 cursor-pointer ${
